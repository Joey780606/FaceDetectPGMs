...
使用 face_recognition 庫 + webcam 進行人臉辨識。
...
DETECT_TICK_MS        = 500    # 辨識時每次推論的間隔（毫秒；face_recognition 較慢）
...
class MainApp(customtkinter.CTk):
    """主應用程式視窗，整合 webcam 與 face_recognition 人臉辨識功能。"""
    ...
    def _DetectNoneTick(self) -> None:
        """
        DetectNone 辨識 tick。
        在背景執行緒執行 face_recognition 推論，避免阻塞 UI。
